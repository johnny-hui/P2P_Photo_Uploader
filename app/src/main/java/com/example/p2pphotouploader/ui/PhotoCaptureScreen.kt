...
import com.example.p2pphotouploader.utility.imageAdjusterPortrait
 ...
 *      capturedImage property with the image taken
 *
 * @param [toNextScreen]
...
private fun takePhotoHandler(
    ...
    onPhotoClickHandler: (Bitmap) -> Unit,
    toNextScreen: () -> Unit): Boolean
{
    var isError = false
    ...
    controller.takePicture(
        ...
        object : OnImageCapturedCallback() {
            override fun onCaptureSuccess(image: ImageProxy) {
                ...
                onPhotoClickHandler(imageAdjusterPortrait(image))

                Toast.makeText(
                    context,
                    context.getString(R.string.image_capture_successful),
                    Toast.LENGTH_SHORT
                ).show()
